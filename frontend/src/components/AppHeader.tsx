...
const AppHeader: React.FC<{ betaLabel?: string }> = ({ betaLabel }) => (
  <header className="w-full bg-white/80 shadow-sm py-4 px-8 flex items-center justify-between border-b border-blue-100">
    <Link
      to="/"
