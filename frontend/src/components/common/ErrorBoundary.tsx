...
class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <section data-testid="error-boundary" className="min-h-screen flex items-center justify-center max-w-md w-full bg-white rounded-lg shadow-lg p-6 border border-red-200">
