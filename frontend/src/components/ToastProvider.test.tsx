  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={() =>
          showToast({ type: "info", title: "Custom", duration: 2000 })
        }
      >
        Custom Duration
      </button>
      <button
        ...
        onClick={() =>
          showToast({ type: "info", title: "No Auto Remove", duration: 0 })
        }
      >
        No Auto Remove
      </button>
      <button
        ...
        onClick={() =>
          showToast({ type: "info", title: "Negative", duration: -1000 })
        }
      >
        Negative Duration
      </button>
...
describe("ToastProvider", () => {
  ...
  describe("Toast Display", () => {
    it("should display success toast with correct styling and icon", async () => {
      ...
      const toastContainer = screen
        .getByText("Success Title")
        .closest('[class*="border-green-200"]');
      expect(toastContainer).toHaveClass("border-green-200", "bg-green-50");

      // Check for success icon (checkmark path)
      expect(screen.getByText("Success Title").closest(".fixed")).toContainHTML(
        "M5 13l4 4L19 7",
      );
    ...
    it("should display warning toast with correct styling", async () => {
      ...
      const toastElement = screen
        .getByText("Warning Title")
        .closest('[class*="border-yellow-200"]');
    ...
    it("should display info toast with correct styling", async () => {
      ...
      const toastElement = screen
        .getByText("Info Title")
        .closest('[class*="border-blue-200"]');
  ...
  describe("Toast Removal", () => {
    ...
    it("should not auto-remove toast with duration 0", () => {
      ...
      const toastTitle = screen
        .getAllByText("No Auto Remove")
        .find((el) => el.closest('[class*="border-blue-200"]'));
      ...
      function DefaultTestComponent() {
        ...
        return (
          <button
            ...
            onClick={() =>
              showToast({
                type: "unknown" as "success",
                title: "Unknown Type Toast",
