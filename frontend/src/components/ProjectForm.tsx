...
const ProjectFormHeader: React.FC<ProjectFormHeaderProps> = ({ editMode, handleCloseButtonClick }) => (
...
const ProjectFormFooter: React.FC<ProjectFormFooterProps> = ({ onClose, loading, handleSubmit, name, editMode, currentType }) => (
