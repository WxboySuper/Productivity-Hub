...
describe("HomePage", () => {
  describe("Page Structure", () => {
    ...
    it('renders the "Why Productivity Hub?" section', () => {
      ...
      expect(
        screen.getByText(
          /Productivity Hub is designed to help you take control/,
        ),
      ).toBeInTheDocument();
    });
    ...
    it("renders the footer with current year", () => {
      ...
      expect(
        screen.getByText(
          `© ${currentYear} Productivity Hub. All rights reserved.`,
        ),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Feature Cards", () => {
    it("renders all feature cards with correct content", () => {
      ...
      expect(
        screen.getByText(
          "Create, organize, and track projects with ease. Stay on top of deadlines and deliverables.",
        ),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText(
          "Visualize your tasks in lists, boards, or calendars. Prioritize and focus on what matters most.",
        ),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText(
          "Gain insights into your productivity patterns and progress with built-in analytics.",
        ),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText(
          "Plan your days, set reminders, and get a unified dashboard for all your work.",
        ),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText(
          "Personalize your workspace to fit your workflow and preferences.",
        ),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText(
          "Work solo or invite teammates. Share projects, assign tasks, and collaborate in real time.",
        ),
      ).toBeInTheDocument();
    });
  ...
  describe("Accessibility", () => {
    ...
    it("has proper semantic structure with main and sections", () => {
      ...
      const section = screen
        .getByText("Why Productivity Hub?")
        .closest("section");
  ...
  describe("Content Validation", () => {
    ...
    it("includes engaging call-to-action text", () => {
      ...
      expect(
        screen.getByText(/take control of your work and life/),
      ).toBeInTheDocument();
      expect(
        screen.getByText(/empower you to achieve more with less stress/),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("User Flow", () => {
    ...
    it("explains value proposition clearly", () => {
      ...
      expect(
        screen.getByText(/all-in-one productivity assistant/),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          /Organize tasks, manage projects, and boost your workflow/,
        ),
      ).toBeInTheDocument();
    });
  });
