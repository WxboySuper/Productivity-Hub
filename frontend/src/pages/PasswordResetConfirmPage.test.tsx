...
describe('PasswordResetConfirmPage', () => {
  ...
  describe('Password Validation', () => {
    ...
    it('allows form submission when passwords match', async () => {
      ...
      await waitFor(() => {
        expect(global.fetch).toHaveBeenCalledWith('/api/password-reset/confirm', expect.any(Object));
      });
    });
  });
  ...
  describe('Error State Handling', () => {
    ...
    it('shows error message with proper styling', async () => {
      ...
      await waitFor(() => {
        const errorMessage = screen.getByText('Passwords do not match.').closest('div');
