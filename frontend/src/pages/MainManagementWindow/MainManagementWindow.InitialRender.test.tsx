...
describe("MainManagementWindow - Initial Render & Sidebar", () => {
  ...
  describe("Initial Render", () => {
    it("renders main components when authenticated", async () => {
      ...
      expect(
        screen.getByLabelText("Change background style"),
      ).toBeInTheDocument();
    ...
    it('starts with "All Tasks" view active', async () => {
      ...
      const allTasksButton = allTasksButtons
  ...
  describe("Sidebar Functionality", () => {
    ...
    it("switches between different views", async () => {
      ...
      const quickTasksButton = quickTasksButtons
        .find((button) => button.closest(".phub-sidebar-nav"))
        ?.closest("button");
      act(() => {
      ...
      const projectsButton = projectsButtons
        .find((button) => button.closest(".phub-sidebar-nav"))
        ?.closest("button");
      act(() => {
    ...
    it("handles logout when logout button is clicked", async () => {
      ...
      const signOutButton = signOutButtons
        .find((button) => button.closest(".phub-sidebar-nav"))
        ?.closest("button");
      act(() => {
